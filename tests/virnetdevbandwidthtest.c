...
#define DO_TEST_SET(Band, Exp_cmd_tc, Exp_cmd_ovs, ...) \
    ...
    DO_TEST_SET("<bandwidth>"
                ...
                TC " class add dev eth0 parent 1: classid 1:1 htb rate 1024kbps ceil 1024kbps quantum 87\n"
                TC " class add dev eth0 parent 1:1 classid 1:2 htb rate 1024kbps ceil 1024kbps quantum 87\n"
    ...
    DO_TEST_SET("<bandwidth>"
                ...
                TC " qdisc del dev eth0 ingress\n"
                TC " qdisc add dev eth0 root handle 1: htb default 1\n"
                TC " class add dev eth0 parent 1: classid 1:1 htb rate 2kbps ceil 2kbps burst 4kb quantum 1\n"
                TC " class add dev eth0 parent 1:1 classid 1:2 htb rate 1kbps ceil 2kbps burst 4kb quantum 1\n"
                TC " qdisc add dev eth0 parent 1:2 handle 2: sfq perturb 10\n"
                TC " filter add dev eth0 parent 1:0 protocol all prio 1 handle 1 fw flowid 1\n"
                TC " qdisc add dev eth0 ingress\n"
                TC " filter add dev eth0 parent ffff: protocol all u32 match u32 0 0"
    ...
    DO_TEST_SET("<bandwidth>"
                ...
                TC " qdisc del dev eth0 ingress\n"
                TC " qdisc add dev eth0 root handle 1: htb default 1\n"
                TC " class add dev eth0 parent 1: classid 1:1 htb rate 4294967295kbps ceil 4294967295kbps quantum 366503875\n"
                TC " class add dev eth0 parent 1:1 classid 1:2 htb rate 4294967295kbps ceil 4294967295kbps quantum 366503875\n"
                TC " qdisc add dev eth0 parent 1:2 handle 2: sfq perturb 10\n"
                TC " filter add dev eth0 parent 1:0 protocol all prio 1 handle 1 fw flowid 1\n"
                TC " qdisc add dev eth0 ingress\n"
