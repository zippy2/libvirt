        ...
        unsigned int flags)
{
    ...
    info->outconf = g_strdup_printf("%s/networkxml2xmlout/%s.conf", abs_srcdir, name);
    info->outhostsfile = g_strdup_printf("%s/networkxml2xmlout/%s.hostsfile", abs_srcdir, name);
