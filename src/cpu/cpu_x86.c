...
#define KVM_FEATURE_DEF(Name, Eax_in, Eax, Ebx, Edx) \
...
static virCPUx86Feature x86_kvm_features[] =
{
    ...
    KVM_FEATURE(VIR_CPU_x86_HV_VSM),
    KVM_FEATURE(VIR_CPU_x86_HV_XMM_OUTPUT),
};
