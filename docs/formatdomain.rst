...
``driver``
   ...
   object will be put onto QEMU command line. Libvirt will open the
   /dev/iommu and VFIO device cdev, passing the associated file
   descriptor numbers to QEMU process.
